...
if (bookReviewBtn) bookReviewBtn.addEventListener("click", function (e) {
...
if (reviewUpdate) reviewUpdate.forEach(function (button) {
...
if (reviewDelete) reviewDelete.forEach(function (button) {
  button.addEventListener("click", function (e) {
